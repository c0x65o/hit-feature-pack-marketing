...
export function PlansList() {
  ...
  const columns = useMemo(
    () => [
      ...
      { key: 'budgetAmount', label: 'Budget', render: (_v: unknown, row: Plan) => <span className="font-mono">{formatUsd(row.budgetAmount)}</span> },
      { key: 'monthSpendAmount', label: 'This month', render: (_v: unknown, row: Plan) => <span className="font-mono">{formatUsd(row.monthSpendAmount)}</span> },
      {
        key: 'isArchived',
        label: 'Status',
