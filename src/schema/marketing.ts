...
export const marketingEntityLinks = pgTable(
  ...
  (table) => ({
    uniqueLink: unique('marketing_entity_links_unique').on(
      table.marketingEntityType,
      table.marketingEntityId,
      table.linkedEntityKind,
      table.linkedEntityId,
    ),
    marketingIdx: index('marketing_entity_links_marketing_idx').on(
      table.marketingEntityType,
      table.marketingEntityId,
    ),
    linkedIdx: index('marketing_entity_links_linked_idx').on(
      table.linkedEntityKind,
      table.linkedEntityId,
    ),
  }),
